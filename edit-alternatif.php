      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Edit Data Alternatif</div>
						<?php
									...
									$result = $mysqli->query("select * from datalaptop where id_alternatif = ".$_GET['id']."");
									if(!$result){
										echo $mysqli->connect_errno." - ".$mysqli->connect_error;
										exit();
									}
							...
							<form role="form" method="post" action="edit.php?id=<?php echo $_GET['id'];?>">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="vtype">Alternatif</label>
                                            <input type="text" class="form-control" name="vtype" id="vtype" value="<?php echo $row["vtype"];?>" placeholder="Jenis Kayu">
                                        </div>
                                                    <div class="form-group">
