		  ...
		  <div class="panel-body">
			<center>
				<?php
					...
					echo "<thead><tr><th>Alternatif / Kriteria</th><th>HARGA</th><th>K1</th><th>K2</th><th>K3</th><th>K4</th><th>K5</th><th>K6</th></tr></thead>";
					for($i=0;$i<$a;$i++){
					...
					echo "<table class='table table-striped table-bordered table-hover'>";
					echo "<thead><tr><th></th><th>HARGA</th><th>K1</th><th>K2</th><th>K3</th><th>K4</th><th>K5</th><th>K6</th><th>Jumlah</th></tr></thead>";
					...
					echo "<table class='table table-striped table-bordered table-hover'>";
					echo "<thead><tr><th></th><th>HARGA</th><th>K1</th><th>K2</th><th>K3</th><th>K4</th><th>K5</th><th>K6</th></tr></thead>";
					...
					for($i=0;$i<$a;$i++){
						...
						$ss[$i] = $s[$i][0]*$s[$i][1]*$s[$i][2]*$s[$i][3]*$s[$i][4]*$s[$i][5]*$s[$i][6];
								...
								for($i=0;$i<$arl2;$i++){ //new for 8 lines below
									...
									elseif($i==($arl2-1))
										...
										function jml_alternatif(){
											include 'configdb.php';
											$vtype = $mysqli->query("select * from datalaptop");
											return $vtype->num_rows;
										}
