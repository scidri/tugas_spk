							...
							<form role="form" method="post" action="add.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="datalaptop">Alternatif</label>
                                            <input type="text" class="form-control" name="vtype" id="vtype" placeholder="Alternatif Laptop">
                                        </div>
										<div class="form-group">
                                            <label for="datalaptop">C1 Harga</label>
                                            <input type="text" class="form-control" name="harga" id="vtype" placeholder="Harga">
                                        </div>

										<div class="form-group">
                                            <label for="k1"><?php echo ucwords($k[1]);?></label>
										...
										<div class="form-group">
                                            <label for="k2"><?php echo ucwords($k[2]);?></label>
										...
										<div class="form-group">
                                            <label for="k3"><?php echo ucwords($k[3]);?></label>
										...
										<div class="form-group">
                                            <label for="k4"><?php echo ucwords($k[4]);?></label>
										...
										<div class="form-group">
                                            <label for="k5"><?php echo ucwords($k[5]);?></label>
										...
										<div class="form-group">
                                            <label for="k6"><?php echo ucwords($k[6]);?></label>
